    ...
    render() {
        return (<div>
            ...
            <form onSubmit={(e) => this.handleClick(e)} >
                    <input className="form-control" id="inputPassword2" type="text" name="msg" placeholder="Chat now" style={{ height: "5vh", width:"100%", borderTop:"2px solid rgba(0, 0, 0, .25)", padding:"1vh", marginTop:"1.5vh", borderBottomRightRadius: "15px" }} />
            </form>
        </div>);
    }
}
